...
const Empleados = () => {
    ...
    const saveProduct = () => {
        ...
        if (product.name.trim()) {
            ...
            if (product.id) {
                ...
                toast.current.show({ severity: 'success', summary: 'Exitoso', detail: 'Empleado Actualizado', life: 3000 });
            } else {
                _product.id = createId();
                _product.image = 'product-placeholder.svg';
                _products.push(_product);
                toast.current.show({ severity: 'success', summary: 'Exitoso', detail: 'Empleado Agregado', life: 3000 });
            }
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Empleados Eiminados', life: 3000 });
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="price" header="Documento" body={nameBodyTemplate} sortable></Column>
                        <Column field="category" header="Fecha Nacimiento" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column field="rating" header="Telefono" body={nameBodyTemplate} sortable></Column>
                        <Column field="inventoryStatus" header="Fecha Ingreso" body={nameBodyTemplate} sortable headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column field="inventoryStatus" header="Correo electronico" body={nameBodyTemplate} sortable headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column field="inventoryStatus" header="Dirección" body={nameBodyTemplate} sortable headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column header="Acciones"body={actionBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
                    </DataTable>

                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Registro Empleados" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            <label htmlFor="description">Fecha Ingreso</label>
                    ...
                    <Dialog visible={deleteProductsDialog} style={{ width: '450px' }} header="Confirmación" modal footer={deleteProductsDialogFooter} onHide={hideDeleteProductsDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {product && <span>Esta seguro que desea eliminar este Empleado ?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
