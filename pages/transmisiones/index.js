...
const Transmisiones = () => {
        ...
        if (transmision.nombre.trim()) {
            if (transmision.idTransmision) {
               try {
                    ...
                    toast.current.show({ severity: 'success', summary: 'Éxito', detail: 'Transmision Actualizada', life: 3000 });
                    pasoRegistro();
                } catch (error) {
                ...
                try {
                    ...
                    toast.current.show({ severity: 'success', summary: 'Éxito', detail: 'Transmision Creada', life: 3000 });
                    pasoRegistro();
                } catch (error) {
                    toast.current.show({ severity: 'error', summary: 'Error', detail: error.errorDetails, life: 3000 });                    
    ...
    const deleteTransmision = async () => {
        ...
        listarTransmisions();
        setDeleteTransmisionDialog(false);
        toast.current.show({ severity: 'success', summary: 'Éxito', detail: 'transmision Eliminada', life: 3000 });
    }
