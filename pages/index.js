                ...
                <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)' }}>
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <InputText inputid="email1" type="text" placeholder="Username" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />
                            ...
                            <Button label="Acceder" className="w-full p-3 text-xl" onClick={() => router.push('/dashboard/')}></Button>
                        </div>
                    </div>
                </div>
            </div>
